...
# SAPI_recognizer = "SAPI.SpSharedRecognizer"
# SAPI_context = "SAPI.SpSharedRecoContext"

SAPI_recognizer = "SAPI.SpInProcRecognizer"
SAPI_context = "SAPI.SpInProcRecoContext"
#---------------------------------------------------------------------------
            ...
            for r in self.grammar._rules:
                ...
                for result in r.decode(s):
                    if s.finished():
                        ...
                        self.grammar.on_rule_matched(root)
                        return
